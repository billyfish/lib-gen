...
{
	BOOL (*wr_write_header_definitions_list_fn) (struct Writer *writer_p, struct List *header_definitions_p, CONST_STRPTR library_s, const int32 version, const enum InterfaceFlag flag, BPTR out_p);
